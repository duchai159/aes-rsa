...
class RSAKey:
    ...
    def __generate_e(self):
        ...
        while True:
            ...
            if utils.is_coprime(e, self.phi) and utils.is_coprime(e, self.n):
                return e
    ...
    def __generate_d(self, e):
        ...
        #   """  
        return utils.find_mod_inverse(e, self.phi)
    ...
    def export_key(self):
        ...
        if not self.isPublic():            
            ...
            str = utils.BASE64Encode(self.get_key(), key_type)
        else:
            key_type = "PUBLIC KEY"
            str = utils.BASE64Encode(self.get_key(), key_type)
...
def import_key(path) -> RSAKey:
    ...
    keys_string = utils.BASE64Decoding(extern_key, key_type) 
